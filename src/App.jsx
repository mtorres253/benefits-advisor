...
export default function App() {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      // Calls our /api/chat proxy — works both locally (via vite proxy) and on Vercel
      ...
      const assistantText =
        ...
        "I'm sorry, I couldn't retrieve information at this time. Please try again.";
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .header {
          ...
          border-bottom: 3px solid #c8a96e; transition: background 0.4s;
        }
        ...
        .status-dot {
          width: 7px; height: 7px; background: #7ecb8f; border-radius: 50%;
        ...
        .veteran-banner {
          ...
          text-align: center; padding: 6px 16px; letter-spacing: 0.8px;
        ...
        .veteran-toggle {
          ...
          background: white; border: 1.5px solid #d4c9b0; border-radius: 12px;
        ...
        .radius-pill {
          ...
          background: #e8f4ec; border: 1px solid #b8d8c0; border-radius: 20px;
          padding: 5px 12px; font-size: 12px; color: #2d5a3d; white-space: nowrap;
        }

        .categories {
          display: flex; gap: 7px; padding: 9px 18px;
          overflow-x: auto; background: #f5f0e8; border-bottom: 1px solid #e0d8c8;
          scrollbar-width: none;
        }
        .categories::-webkit-scrollbar { display: none; }
        .category-chip {
          display: flex; align-items: center; gap: 5px; padding: 4px 11px;
          background: white; border: 1px solid #d4c9b0; border-radius: 20px;
          font-size: 12px; font-weight: 500; color: #5a4a30; white-space: nowrap;
        ...
        .qs-btn {
          background: white; border: 1.5px solid #c8a96e; border-radius: 10px;
          padding: 11px 15px; text-align: left; font-family: 'Source Sans 3', sans-serif;
          font-size: 13.5px; color: #4a3a20; cursor: pointer; transition: all 0.2s; line-height: 1.4;
        }
        ...
        .avatar {
          width: 34px; height: 34px; border-radius: 9px; background: #2d5a3d;
        ...
        .typing-indicator {
          display: flex; gap: 5px; padding: 13px 17px; background: white;
          border: 1px solid #e8e0d0; border-radius: 16px; border-top-left-radius: 4px;
          width: fit-content; box-shadow: 0 2px 8px rgba(0,0,0,0.04);
        }
        .typing-indicator span {
          width: 7px; height: 7px; background: #c8a96e;
        ...
        .input-box {
          flex: 1; background: white; border: 1.5px solid #d4c9b0; border-radius: 12px;
          padding: 11px 15px; font-family: 'Source Sans 3', sans-serif; font-size: 14px;
          color: #2a2010; resize: none; outline: none; transition: border-color 0.2s;
          min-height: 46px; max-height: 110px;
        }
        .input-box:focus { border-color: #2d5a3d; }
        .app.vet .input-box:focus { border-color: #9b6030; }
        .input-box::placeholder { color: #b0a080; }
        .send-btn {
          width: 46px; height: 46px; background: #2d5a3d; border: none; border-radius: 12px;
      ...
      <div className={`app ${isVeteran ? "vet" : ""}`}>
        <div className="header">
          ...
          <div className="header-text">
            ...
            <p><span className="status-dot" />Autonomous AI agent · All 50 states · 10-mile radius search</p>
          </div>
        </div>
        ...
        <div className="input-area">
          <div className="input-row">
            <textarea
              ...
              placeholder={
                isVeteran
                  ? "Enter a city, state, or zip code to find veteran & senior benefits..."
                  : "Enter a city, county, state, or zip code..."
              }
              rows={1}
              disabled={isLoading}
            />
